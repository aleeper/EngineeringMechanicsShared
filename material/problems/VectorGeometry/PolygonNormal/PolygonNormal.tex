...
%
\\[0.45pc]
In the figure below, the \uvecxyz{a} measures of the position vector to each
vertex from \origin{A} are labeled.
\\[0.0pc]
For example, $\posvec{\origin{A}}{P_1} \equals[\;] 3~\uvecx{a} \plus[\;] 2~\uvecy{a}
\plus[\;] 0~\uvecz{a}$.
%
\begin{center}
