%   File: inclined_block_statics.tex
% Author: Adam Leeper
%------------------------------------------------------------------------------
%\\[0.45pc]
...
\\[1.0pc]
\textColorBold{darkerBlue}{Statics of a Block on an Inclined Plane}
\\[0.45pc]
}
%%%
%%%
...
%
%
Using $\force{S} = \bvec{0}$ might lead to the following vector
...
%
%
\item  Find a scalar expression for $x$.
  (This gives the equilibrium stretch or compression of the spring).
  \\[0.45pc]
  \Solution{}{1.0\linewidth}{
    ...
    \begin{tabular}{@{}r@{$\equals[\;]$}ll}
     ...
     $\uvecx{b} \cdot \bvec{0}$
      ...
      $\leftarrow$ Find dot products from definition.
      \\[0.5pc]
      $ -kx \plus[\;] 0 \minus[\;] mg \sin(\theta)$ & $0$
      \\[0.5pc]
      $ x $ & $ -\frac{m}{k} g \sin(\theta)$
    \end{tabular}
    \\[1.0pc]
  }
\end{enumerate}
